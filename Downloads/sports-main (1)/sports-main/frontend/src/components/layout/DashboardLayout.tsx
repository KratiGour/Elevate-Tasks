...
const dashboardItems: Record<string, NavItem[]> = {
  PLAYER: [
    ...
    { to: "/", icon: "fas fa-globe", label: "Website Dashboard" },
...
export const DashboardLayout: React.FC<DashboardLayoutProps> = ({ children }) => {
  ...
  return (
    <div className="min-h-screen relative overflow-hidden transition-all duration-500 bg-gradient-to-br from-gray-50 via-white to-gray-100 dark:from-[#070A14] dark:via-[#0A0F1C] dark:to-[#0D1117]">
      ...
      <header className="lg:hidden fixed top-0 left-0 right-0 z-50 glass border-b border-white/10">
        <div className="flex items-center justify-between p-4">
          <div className="flex items-center gap-3">
            ...
            <span className="font-bold text-xl text-gray-800 dark:text-white">SportVision</span>
          </div>
          <motion.button
            whileTap={{ scale: 0.95 }}
        ...
        >
          ...
          <div className="h-full flex flex-col">
            ...
            <div className="hidden lg:flex items-center gap-3 p-6 border-b border-white/10">
              ...
              <div>
                <span className="font-bold text-lg text-gray-800 dark:text-white">SportVision</span>
                  ...
                  <NavLink
                    ...
                    className={({ isActive }) =>
                      `flex items-center gap-3 px-4 py-3 rounded-xl transition-all duration-300 group ${isActive
                        ...
                        : "text-gray-600 dark:text-white/60 hover:text-gray-800 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-white/5 border border-transparent"
                      }`
                    }
                  >
                    {({ isActive }) => (
                      <>
                        <div className={`w-9 h-9 rounded-lg flex items-center justify-center transition-all duration-300 ${isActive
                          ...
                          <i className={`${item.icon} text-sm ${isActive ? 'text-white' : 'text-gray-600 dark:text-white/60 group-hover:text-gray-800 dark:group-hover:text-white'}`}></i>
                        </div>
            ...
            <div className="p-4 border-t border-white/10">
              <motion.button
                ...
                className="w-full flex items-center gap-3 px-4 py-3 rounded-xl text-gray-600 dark:text-white/60 hover:text-red-400 hover:bg-red-500/10 transition-all duration-300 group"
              >
                <div className="w-9 h-9 rounded-lg bg-gray-200 dark:bg-white/10 group-hover:bg-red-500/20 flex items-center justify-center transition-all duration-300">
      ...
      {toast && (
        <div className="fixed top-4 right-4 z-50">
          <div className={`p-4 rounded-xl border backdrop-blur-sm shadow-lg min-w-[300px] ${
            toast.type === 'success' 
      ...
      <main className="lg:ml-72 pt-16 lg:pt-0 min-h-screen relative z-10">
        <div className="p-6 lg:p-8 max-w-7xl mx-auto">
          ...
          <nav className="flex items-center space-x-2 text-sm mb-6">
            <span className="text-gray-600 dark:text-white/60">Home</span>
            <i className="fas fa-chevron-right text-xs text-gray-400 dark:text-white/30"></i>
