...
export const PublicLayout: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-100 dark:from-[#070A14] dark:via-[#0A0F1C] dark:to-[#0D1117] relative overflow-hidden">
          ...
          <div className="flex items-center justify-between h-16">
            ...
            <Link to="/" className="flex items-center gap-3">
              ...
              <div className="hidden sm:block">
                <span className="text-lg font-bold text-gray-800 dark:text-white">SportVision</span>
            ...
            <nav className="flex items-center gap-2 sm:gap-4">
              <Link
                to="/library"
                className="px-3 py-2 text-sm transition-colors text-gray-600 dark:text-white/70 hover:text-gray-800 dark:hover:text-white"
              >
              ...
              {isAuthenticated && user ? (
                <>
                  ...
                  <motion.button
                    ...
                    className="px-4 py-2 text-sm transition-all rounded-xl text-gray-600 dark:text-white/70 hover:text-red-400 hover:bg-red-500/10"
                  >
                ...
                <>
                  <Link
                    to="/login"
                    className="px-4 py-2 text-sm transition-all rounded-xl text-gray-600 dark:text-white/70 hover:text-gray-800 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-white/10"
                  >
                    Login
                  </Link>
      ...
      {!isAuthenticated && (
        ...
        >
          <div className="flex flex-col items-center justify-between gap-3 px-4 py-3 mx-auto max-w-7xl sm:flex-row">
            <p className="text-sm text-center text-gray-600 dark:text-white/70 sm:text-left">
            ...
            <div className="flex items-center gap-2">
              ...
              <Link
                to="/register"
                className="px-4 py-2 text-sm transition-all border rounded-lg border-gray-300 dark:border-white/20 text-gray-600 dark:text-white/70 hover:text-gray-800 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-white/10"
              >
                Register
              </Link>
            </div>
