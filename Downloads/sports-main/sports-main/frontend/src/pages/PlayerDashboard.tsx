  ...
  return (
    <div className="text-black dark:text-white space-y-8">
      ...
      <motion.div
        ...
        className="glass rounded-3xl p-6 border-2 border-gray-400 dark:border-white/20 bg-gray-100 dark:bg-transparent shadow-md dark:shadow-none"
      >
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
        {stats.map((s, i) => (
          <motion.div
            ...
            className="glass rounded-2xl p-6 border-2 border-gray-400 dark:border-white/20 bg-gray-100 dark:bg-transparent shadow-md dark:shadow-none hover:border-gray-500 dark:hover:border-white/30 transition-all duration-300 group cursor-pointer"
          >
            ...
            <p className="text-sm text-gray-600 dark:text-white/60 mb-2">{s.title}</p>
      ...
      <div className="grid lg:grid-cols-2 gap-6">
        ...
        <motion.div
          ...
          transition={{ duration: 0.6 }}
          className="glass rounded-3xl p-6 border-2 border-gray-400 dark:border-white/20 bg-gray-100 dark:bg-transparent shadow-md dark:shadow-none hover:border-gray-500 dark:hover:border-white/30 transition-all duration-300"
        >
          ...
          <div className="h-72">
            <ResponsiveContainer width="100%" height="100%">
              <LineChart data={lineData}>
                <CartesianGrid strokeDasharray="3 3" stroke="rgba(0,0,0,0.2)" className="dark:stroke-white/10" />
                <XAxis dataKey="day" stroke="rgba(0,0,0,0.7)" className="dark:stroke-white/60" />
                <YAxis stroke="rgba(0,0,0,0.7)" className="dark:stroke-white/60" />
                <Tooltip 
                  contentStyle={{
            ...
            {barData.length > 0 ? (
              <ResponsiveContainer width="100%" height="100%">
                <BarChart data={barData}>
                  <CartesianGrid strokeDasharray="3 3" stroke="rgba(0,0,0,0.2)" className="dark:stroke-white/10" />
                  <XAxis dataKey="name" stroke="rgba(0,0,0,0.7)" className="dark:stroke-white/60" />
                  <YAxis stroke="rgba(0,0,0,0.7)" className="dark:stroke-white/60" />
                  <Tooltip 
                    contentStyle={{
                      backgroundColor: 'rgba(0,0,0,0.8)',
              ...
              <div className="h-full flex items-center justify-center text-gray-500 dark:text-white/40">
      ...
      <div className="grid lg:grid-cols-3 gap-6">
        ...
        <motion.div
          ...
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.6 }}
          className="lg:col-span-2 glass rounded-3xl p-6 border-2 border-gray-400 dark:border-white/20 bg-gray-100 dark:bg-transparent shadow-md dark:shadow-none"
        >
