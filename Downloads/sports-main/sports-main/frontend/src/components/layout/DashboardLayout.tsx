...
export const DashboardLayout: React.FC<DashboardLayoutProps> = ({ children }) => {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gradient-to-br dark:from-[#070A14] dark:via-[#0A0F1C] dark:to-[#0D1117] relative overflow-hidden">
      ...
      {/* Mobile Header */}
      <header className="lg:hidden fixed top-0 left-0 right-0 z-50 glass border-b border-white/10 dark:bg-white dark:border-gray-200">
        <div className="flex items-center justify-between p-4">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl bg-gradient-to-r from-blue-500 to-purple-600 flex items-center justify-center">
              <i className="fas fa-cricket-bat-ball text-white"></i>
            </div>
            <span className="font-bold text-xl text-white dark:text-black">SportVision</span>
          </div>
          <div className="flex items-center gap-2">
            ...
            <motion.button
              ...
              className="w-10 h-10 rounded-xl glass border border-white/20 dark:border-gray-300 dark:bg-gray-100 flex items-center justify-center text-white dark:text-black hover:bg-white/10 dark:hover:bg-gray-200 transition-all"
            >
      ...
      <AnimatePresence>
        <motion.aside
          className={`
            fixed top-0 left-0 z-40 h-screen w-72 bg-white dark:bg-gradient-to-br dark:from-[#070A14] dark:via-[#0A0F1C] dark:to-[#0D1117] border-r border-gray-200 dark:border-white/10
        ...
        >
          ...
          <div className="h-full flex flex-col">
            {/* Logo */}
            <div className="hidden lg:flex items-center gap-3 p-6 border-b border-gray-300 dark:border-white/10">
              ...
              <div className="flex-1">
                <span className="font-bold text-lg text-black dark:text-white">SportVision</span>
            ...
            {/* User Info */}
            <div className="p-4 mt-16 lg:mt-0 border-b border-gray-300 dark:border-white/10">
              <motion.div 
                whileHover={{ scale: 1.02 }}
                className="glass rounded-2xl p-4 border-2 border-gray-300 dark:border-white/10 bg-gray-50 dark:bg-transparent cursor-pointer"
              >
                <div className="flex items-center gap-3">
                  ...
                  <NavLink
                    ...
                    className={({ isActive }) =>
                      `flex items-center gap-3 px-4 py-3 rounded-xl transition-all duration-300 group ${
                        isActive
                          ? "bg-gradient-to-r from-blue-500/20 to-purple-500/20 text-black dark:text-white border border-gray-400 dark:border-white/20"
                          : "text-gray-700 dark:text-white/60 hover:text-black dark:hover:text-white hover:bg-gray-200 dark:hover:bg-white/5 border border-transparent"
                      }`
                    }
                  >
                    {({ isActive }) => (
      ...
      {/* Main Content */}
      <main className="lg:ml-72 pt-16 lg:pt-0 min-h-screen relative z-10 bg-white dark:bg-transparent">
        <div className="p-6 lg:p-8 text-black dark:text-white">
          {children || <Outlet />}
        </div>
      </main>
    </div>
